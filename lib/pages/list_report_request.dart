...
class ListReportReqDept extends StatefulWidget {
  static const String route = '/ListReportReqDepartment';

  final int index;
  final UserModel userModel;
  ListReportReqDept({Key key, this.index, this.userModel}) : super(key: key);

  @override
  _ListReportReqDeptState createState() => _ListReportReqDeptState();
}
...
class _ListReportReqDeptState extends State<ListReportReqDept> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('รายงาน :: สรุปการขอใช้บริการ'),
        actions: <Widget>[
          // AddStaff(),
        ],
      ),
